...
public class PrimaryAggregatedInterval {
    ...
    public static void run(JSONObject params) throws IOException {
        ...
        try {
            ...
            Logger logger = initLogger(String.format("PrimaryAggregatedInterval_%s",producerTopic));
...
//        Get Latest Kline from historical server
            ...
            logger.info("primaryIndicatorAgg:" + primaryIndicatorAgg + "\n\n");
...
//        Consume Klines and aggregate
            while (true) {
                ...
                for (ConsumerRecord<Long, String> record : records) {
                    ...
                    logger.info(String.format("Primary indicator (%s) : %s%n%n",params,previousIndicatorDatapoints));
